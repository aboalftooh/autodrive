...
## v00 — Static Preparation Baseline

- ثُبت اكتمال 16 Module.
- أضيفت بوابة تحقق ساكنة مستقلة دون Gradle.
- نجحت اختبارات السلوك 48/48 والمراجعات المعمارية 81/81.
- لم يتغير كود الإنتاج.

## v01 — Baseline and Test Gates

### أضيف

- Script موحد `verify-v01-static.sh`.
- جرد آلي لكل 142 حالة اختبار وتصنيفها دون حالات مجهولة.
- تقرير بوابات Build وTests وArchitecture وLint.
- توثيق واضح للاختبارات الثلاثة عشر المؤجلة بسبب نطاق التشغيل الساكن.

### لم يتغير

- كود الإنتاج، Room، Gradle build files، قواعد الأعمال، والواجهات.
